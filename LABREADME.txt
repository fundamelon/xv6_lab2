...
1.1: Semaphores
    Test program: run "test_sema" in xv6.
    Screenshot: 
        "1_1_Sema.PNG": shot of output generated by test_sema.c
...
1.2: Thread yield
    ...
    Screenshot:
        "1_2_Yield.PNG": shot of output from test_yield.c
...
1.3: Synchronization problems
    1: H2O problem
        ...
        Screenshots:
            "1_3_1_H2O.PNG": total output of H2O problem
    ...
    2: Monkey problem
        ...
        Screenshots:
            "1_3_2A_BasicMonkeys.PNG": part 1 of monkey problem
            "1_3_2B_AdvancedMonkeys.PNG": part 3 of monkey problem
    ...
    3: Missionary problem
        ...
        Screenshots:
           "1_3_3A_Missionary.PNG": basic test of missionary problem
           "1_3_3B_Missionary.PNG": first complicated test of missionary problem
           "1_3_3C_Missionary.PNG": second complicated test of missionary problem
        ...
        Additional note: Two functions are used to easily test this part: sendMissionaries and sendCannials().  Each takes an int and starts that many threads.  In addition, each Missionary or Cannibal thread also has a mutex - sem_arrival - which prevents out-of-order arrivals that could mess up the tests and lead to deadlock.

2.1: Null pointer dereference
    Test program: run "null" in xv6.  A trap 14 error should appear.
    Screenshot:
        "2_1_Null.PNG": shot of pagefault generated by null.c
